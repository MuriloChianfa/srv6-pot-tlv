...
if [ -z "$1" ]; then
  ...
  echo "Available algorithms: blake3, siphash, halfsiphash, poly1305, hmac-sha1, hmac-sha256"
  exit 1
fi

ALGO=$1
ALLOWED_ALGOS=("blake3" "siphash" "halfsiphash" "poly1305" "hmac-sha1" "hmac-sha256")
